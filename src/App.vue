<template>
  <div class="hero">
    <div class="heroUnderlay"></div>
    <div class="heroOverlayWrap">
      <div class="heroOverlay">
        <h1 class="heroOverlayHeading">
          Explore
        </h1>
        <button class="heroOverlayBtn" @click="showModal = true">
          <svg class="heroOverlayBtnSVG" xmlns="http://www.w3.org/2000/svg" width="43" height="43" viewBox="0 0 43 43">
            <g>
              <g>
                <path fill="#fff"
          ...
          <span class="heroOverlayBtnText">More Details</span>
        </button>
        <Modal v-if="showModal" @close="showModal = false"/>
      </div>

      <div class="heroOverlaySocials">
        <a class="heroOverlaySocialsFacebook" href="https://www.facebook.com/udundi/" target="_blank" rel="noopener">
          <svg class="heroOverlaySocialsSVG" xmlns="http://www.w3.org/2000/svg" width="68" height="67"
               viewBox="0 0 68 67">
            <g>
              <g>
                <path fill="#fff"
        ...
        <a class="heroOverlaySocialsInsta" href="https://www.instagram.com/udundi/" target="_blank" rel="noopener">
          <svg class="heroOverlaySocialsSVG" xmlns="http://www.w3.org/2000/svg" width="73" height="74"
               viewBox="0 0 73 74">
            <g>
              <g>
                <g>
